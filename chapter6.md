...
2.  **Necrosis (Uncontrolled Cell Death):** This is a messy, inflammatory death often triggered by extreme insults like ischemia-reperfusion injury. A massive influx of calcium and high levels of ROS can trigger the opening of a non-specific mega-channel in the inner membrane known as the **Mitochondrial Permeability Transition Pore (mPTP)**. While its exact composition is still debated, its opening is a catastrophic event. The proton gradient collapses, ATP synthesis reverses (the synthase starts hydrolyzing ATP), and the matrix swells osmotically, rupturing both mitochondrial membranes and spilling the cell's contents into the surrounding tissue. The mPTP acts as a point of no return, committing the cell to a necrotic death.

## A Biosynthetic Factory

Mitochondria are a key source of building blocks for essential biomolecules. The Krebs cycle is not a closed loop; its intermediates can be siphoned off to provide the carbon skeletons for:
*   **Heme groups:** For hemoglobin and cytochromes.
*   **Amino acids:** Such as glutamate and aspartate.
*   **Nucleotides:** Particularly pyrimidines.
...
One of the most exciting recent discoveries is the central role of mitochondria in the innate immune system's response to viral infection. The outer mitochondrial membrane is decorated with a protein called **MAVS (Mitochondrial Antiviral-Signaling protein)**. When a cell detects a viral RNA in its cytosol, the sensor protein (RIG-I) is activated and travels to the mitochondrion, where it engages with MAVS. This triggers MAVS to polymerize into long, prion-like filaments that cover the mitochondrial surface. This aggregation acts as a massive signaling platform, recruiting the machinery needed to launch a powerful type-I interferon response to fight the virus. The mitochondrion, therefore, acts as a physical scaffold for coordinating the cell's first line of defense.

## Thermogenesis: Producing Heat on Demand

In **brown adipose tissue (BAT)**, mitochondria can be switched from producing ATP to producing heat. This is mediated by **Uncoupling Protein 1 (UCP1)**, which, when activated, creates a proton leak across the inner membrane. This short-circuits the ATP synthase, causing the energy of the proton-motive force to be dissipated directly as heat. UCP1 is activated by fatty acids, which are liberated in response to cold stimulation. This provides a perfect system where the fuel for the fire (fatty acids) also acts as the switch that turns it on, allowing for rapid heat production to maintain body temperature. 